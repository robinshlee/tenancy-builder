...
Tenancy-builder is an internal tool for letting agents that turns raw tenancy details into a formatted, ready-to-sign tenancy agreement in minutes.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "6813654+robinshlee@users.noreply.github.com"
  git config user.name "robinshlee"
  ```
