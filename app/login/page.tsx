    ...
    <div className="min-h-screen bg-navy-950 relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex items-center px-6 sm:px-12 py-12">
        <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="w-full max-w-sm ml-auto space-y-6 glass-panel rounded-2xl p-8 shadow-2xl">
            <div>
              <h2 className="text-xl font-bold tracking-tight text-white">Log in</h2>
              <p className="text-sm text-slate-400 mt-1">Log in to your Tenancy Builder account</p>
            </div>
            <Suspense>
              <AuthForm mode="login" />
            </Suspense>
