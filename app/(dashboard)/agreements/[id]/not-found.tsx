...
export default function AgreementNotFound() {
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-20 text-center">
      ...
      <p className="text-slate-400 mb-6">This agreement doesn&apos;t exist or may have been deleted.</p>
      <Link href="/agreements" className="text-sm text-teal-300 hover:text-teal-200 underline">
        Back to agreements
      </Link>
    </main>
  );
