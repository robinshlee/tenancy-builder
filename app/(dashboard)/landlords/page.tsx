  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      <div className="flex items-center justify-between mb-6 gap-3">
        ...
        <Link href="/landlords/new" className="inline-flex items-center gap-1.5 bg-teal-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-teal-400 transition-colors whitespace-nowrap">
          <AddIcon className="w-4 h-4" /> New Landlord
        </Link>
      </div>
      ...
      {!loadError && landlords.length === 0 && (
        <div className="text-center py-20 border border-dashed border-white/15 rounded-lg">
          ...
          <Link href="/landlords/new" className="inline-flex items-center gap-1.5 bg-teal-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-teal-400 transition-colors">
            <AddIcon className="w-4 h-4" /> New Landlord
          </Link>
        </div>
      )}
